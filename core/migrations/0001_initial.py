# Generated by Django 5.2 on 2025-04-16 23:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('admin', 'Administrador'), ('profissional', 'Profissional'), ('paciente', 'Paciente')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cor_raca', models.CharField(choices=[('branca', 'Branca'), ('preta', 'Preta'), ('parda', 'Parda'), ('amarela', 'Amarela'), ('indígena', 'Indígena'), ('prefiro não informar', 'Prefiro não informar')], default='branco', max_length=20)),
                ('sexo', models.CharField(choices=[('masculino', 'Masculino'), ('feminino', 'Feminino'), ('outro', 'Outro'), ('prefiro não informar', 'Prefiro não informar')], max_length=20)),
                ...
                ('estado_civil', models.CharField(choices=[('solteiro(a)', 'Solteiro(a)'), ('casado(a)', 'Casado(a)'), ('divoriado(a)', 'Divorciado(a)'), ('viuvo(a))', 'Viúvo(a)'), ('uniao estavel', 'União estável')], max_length=20)),
                ...
                ('numero', models.TextField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cargo', models.CharField(choices=[('profissional', 'Profissional'), ('recepcionista', 'Recepcionista'), ('admin', 'Administrador')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forma_pagamento', models.CharField(choices=[('pix', 'Pix'), ('debito', 'Cartão de Débito'), ('credito', 'Cartão de Crédito'), ('dinheiro', 'Dinheiro')], max_length=20)),
